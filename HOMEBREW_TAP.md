...
on:
  ...
  workflow_dispatch:
    inputs:
      tag:
        description: Release tag to publish to the shared Homebrew tap
        required: true
        type: string
